...
declare namespace Wizard {
  ...
  export interface SectionControl extends Section {
    readonly slug: string; // Not undefined, will be autogenerated if not supplied
    readonly routes: Record<string, Wizard.RouteControl>;
    readonly pages: Record<string, Wizard.PageControl>;
    readonly src: Section;
    public sectionNextId: string | null;
    public sectionPreviousId: string | null;
  }
